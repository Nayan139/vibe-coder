      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 pt-24 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-tight mb-6 bg-linear-to-r from-gray-900 via-violet-800 to-blue-700 bg-clip-text text-transparent">
            {' '}
            Ship Change's Return{' '}
          </h1>
          <p className="text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            {' '}
            Connect your GitHub repo, describe what you want in plain English,
            ...
            <div className="p-6 font-mono text-sm space-y-2">
              <div className="text-gray-400">
                ...
                <span className="text-white">
                  Change the hero button color to green and update the text to
                  "Get Started Free"
                </span>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-xl mx-auto">
              {' '}
              From repo connection to merged PR — all without touching a
              terminal.{' '}
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  'Sign up with email, then connect GitHub or GitLab to grant repo access. Your login is separate from your Git connection.',
              },
              {
                step: '02',
                icon: GitBranch,
                ...
                description:
                  'Pick any repo from your account. AI reads the README to understand the project structure automatically.',
              },
              {
                step: '03',
                icon: Bot,
                ...
                description:
                  'Type what you want in plain English. AI selects the relevant files, makes the changes, and shows you a side-by-side diff.',
              },
              {
                step: '04',
                icon: Zap,
                ...
                description:
                  'Review the diff, click push, and AI creates the branch, commits your changes, and raises a PR with a professional description.',
              },
            ].map((item, i) => (
      ...
      <section className="py-20 px-6 bg-linear-to-r from-violet-600 to-blue-600">
        ...
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <h2 className="text-4xl font-bold mb-4">
            Ready to ship without code?
          </h2>{' '}
          <p className="text-violet-100 text-lg mb-8">
            {' '}
            Join developers and non-developers who are shipping changes faster
            with AI.{' '}
          </p>{' '}
          <Link href="/signup">
            {' '}
            <Button
              size="lg"
              className="bg-white text-violet-700 hover:bg-violet-50 px-10 h-12 text-base font-semibold gap-2"
            >
              {' '}
